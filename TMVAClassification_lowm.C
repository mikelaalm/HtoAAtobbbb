...
void TMVAClassification_lowm()
{
  TFile *outputFile = TFile::Open("TMVA_M12_lowm.root", "RECREATE");

  TMVA::Factory *factory = new TMVA::Factory("MVAnalysis", outputFile, "!V");

  TMVA::DataLoader *dataloader = new TMVA::DataLoader("MVAnalysis");

  TFile *input_signal = TFile::Open("histos_M12_lowm.root");
  TFile *input_DY4 = TFile::Open("histos_DY_4_lowm.root");
  TFile *input_DY3 = TFile::Open("histos_DY_3_lowm.root");
  TFile *input_DY2 = TFile::Open("histos_DY_2_lowm.root");
  TFile *input_DY1 = TFile::Open("histos_DY_1_lowm.root");
  TFile *input_TTDileptonic = TFile::Open("histos_TT_Dileptonic_lowm.root");
  TFile *input_TTSemileptonic = TFile::Open("histos_TT_Semileptonic_lowm.root");
