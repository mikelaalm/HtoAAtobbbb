...
//by  b_branchname->GetEntry(ientry); //read only this branch
  ...
  TH1F *h_etaH = new TH1F("h_etaH"," ; Higgs #eta  ; Events",50,-5.,5.);
  TH1F *h_phiH = new TH1F("h_phiH"," ; Higgs #phi  ; Events",25,-TMath::Pi(),TMath::Pi());
  TH1F *h_mH   = new TH1F("h_mH"  ," ; Higgs mass [GeV]  ; Events",40,120.,130.);
 

  //create histograms for the Z boson

  TH1F *h_ptZ  = new TH1F("h_ptZ", " ; Z boson p_{T} [GeV] ; Events ",100,0.,500.);
  TH1F *h_etaZ = new TH1F("h_etaZ"," ; Z boson #eta  ; Events",50,-5.,5.);
  TH1F *h_phiZ = new TH1F("h_phiZ"," ; Z boson #phi  ; Events",25,-TMath::Pi(),TMath::Pi());
  TH1F *h_mZ   = new TH1F("h_mZ"  ," ; Z boson mass [GeV]  ; Events",50,80.,100.);

  //create histograms for the first A particle (imc=6)

  TH1F *h_ptA1  = new TH1F("h_ptA1" ," ; A_{1} p_{T} [GeV] ; Events",100,0.,500.);
  TH1F *h_etaA1 = new TH1F("h_etaA1"," ; A_{1} #eta  ; Events",50,-5.,-5.);
  TH1F *h_phiA1 = new TH1F("h_phiA1"," ; A_{1} #phi  ; Events",25,-TMath::Pi(),TMath::Pi()); 
  TH1F *h_mA1   = new TH1F("h_mA1"  ," ; A_{1} mass [GeV]; Events",25,10.,70.);

 
  //create histograms for the second A particle (imc=7)

  TH1F *h_ptA2  = new TH1F("h_ptA2" ," ; A_{2} p_{T} [GeV] ; Events",100,0.,500.);
  TH1F *h_etaA2 = new TH1F("h_etaA2"," ; A_{2} #eta  ; Events",50,-5.,-5.);
  TH1F *h_phiA2 = new TH1F("h_phiA2"," ; A_{2} #phi  ; Events",25,-TMath::Pi(),TMath::Pi());
  TH1F *h_mA2   = new TH1F("h_mA2"  ," ; A_{2} mass [GeV] ; Events",25,10.,70.);

   
  //create histograms for the first b quark (imc=8 & mc_momidx=6)

  TH1F *h_ptb11  = new TH1F("h_ptb11" , " ; b_{11} p_{T} [GeV] ; Events",50,0.,500.);
  TH1F *h_etab11 = new TH1F("h_etab11", " ; b_{11} #eta  ; Events",50,-5.,-5.);
  TH1F *h_phib11 = new TH1F("h_phib11", " ; b_{11} #phi  ; Events",25,-TMath::Pi(),TMath::Pi());
  TH1F *h_mb11   = new TH1F("h_mb11"  , " ; b_{11} mass [GeV] ; Events",25,0.,20.);
  

  //create histograms for the second b quark (imc=9 & mc_momidx=6)

  TH1F *h_ptb12  = new TH1F("h_ptb12" , " ; b_{12} p_{T} [GeV]; Events",50,0.,500.);
  TH1F *h_etab12 = new TH1F("h_etab12", " ; b_{12} #eta  ; Events",50,-5.,-5.);
  TH1F *h_phib12 = new TH1F("h_phib12", " ; b_{12} #phi  ; Events",25,-TMath::Pi(),TMath::Pi());
  TH1F *h_mb12   = new TH1F("h_mb12"  , " ; b_{12} mass [GeV] ; Events",25,0.,20.);

  //create histograms for the third b quark (imc=10 & mc_momidx=7)
  
  TH1F *h_ptb21  = new TH1F("h_ptb21" , " ; b_{21} p_{T} [GeV]; Events",50,0.,500.);
  TH1F *h_etab21 = new TH1F("h_etab21", " ; b_{21} #eta  ; Events",50,-5.,-5.);
  TH1F *h_phib21 = new TH1F("h_phib21", " ; b_{21} #phi  ; Events",25,-TMath::Pi(),TMath::Pi());
  TH1F *h_mb21   = new TH1F("h_mb21"  , " ; b_{21} mass [GeV] ; Events",25,0.,20.);

  //create histograms for the fourth b quark (imc=11 & mc_momidx=7)

  TH1F *h_ptb22  = new TH1F("h_ptb22" , " ; b_{22} p_{T} [GeV]; Events",50,0.,500.);
  TH1F *h_etab22 = new TH1F("h_etab22", " ; b_{22} #eta  ; Events",50,-5.,-5.);
  TH1F *h_phib22 = new TH1F("h_phib22", " ; b_{22} #phi  ; Events",25,-TMath::Pi(),TMath::Pi());
  TH1F *h_mb22   = new TH1F("h_mb22"  , " ; b_{22} mass [GeV] ; Events",25,0.,20.);

  //pT(2b)-m(2b) plane (truth)
  
  TH2F *h_pt2b_m2b_truth_vector = new TH2F("h_pt2b_m2b_truth_vector", " ; m(2b) from A_{1} [GeV] ; p_{T}(2b) from A_{1} [GeV]",30, 0., 200., 50, 0., 600.);
  TH1F *h_pt2b_truth_vector = new TH1F("h_pt2b_truth_vector", " ; p_{T}(2b) from A_{1} [GeV]; Events", 50, 0., 600.);
  TH2F *h_pt2b_m2b_truth_vector_other = new TH2F("h_pt2b_m2b_truth_vector_other", " ; m(2b) from A_{2} [GeV]; p_{T}(2b) from A_{2} [GeV]",30, 0., 200., 50, 0., 600.);
  TH1F *h_pt2b_truth_vector_other = new TH1F("h_pt2b_truth_vector_other", " ; p_{T}(2b) from A_{2} [GeV]; Events", 50, 0., 600.);
  TH1F *h_m2b_truth = new TH1F("h_m2b_truth", " ; m(2b) from A_{1} [GeV] ; Events", 30, 0., 200.);
  TH1F *h_m2b_truth_other = new TH1F("h_m2b_truth_other", " ; m(2b) from A_{2} [GeV] ; Events", 30, 0., 200.);

  //create histograms for the antilepton

  TH1F *h_pt_l1  = new TH1F("h_pt_l1" ," ; l_{1} p_{T} [GeV]; Events",50,0.,300.);
  TH1F *h_eta_l1 = new TH1F("h_eta_l1"," ; l_{1} #eta ; Events",50,-5.,5.);
  TH1F *h_phi_l1 = new TH1F("h_phi_l1"," ; l_{1} #phi ; Events",25,-TMath::Pi(),TMath::Pi());
  //TH1F *h_m_l1 = new TH1F("h_m_l1"  ," ; l_{1} mass [GeV] ; Events",100,0.,1.);
 

  //create histograms for the lepton

  TH1F *h_pt_l2  = new TH1F("h_pt_l2" ," ; l_{2} p_{T} [GeV]; Events",50,0.,300.);
  TH1F *h_eta_l2 = new TH1F("h_eta_l2"," ; l_{2} #eta ; Events",50,-5.,5.);
  TH1F *h_phi_l2 = new TH1F("h_phi_l2"," ; l_{2} #phi ; Events",25,-TMath::Pi(),TMath::Pi());
  ...
  TH1F *h_HT_G = new TH1F("h_HT_G", " ; H_{T} [GeV] ; Events", 33, 0. ,600.);
  TH1F *h_ptb_v_sum = new TH1F("h_ptb_v_sum"," ; p_{T} bbb(b) [GeV] ; Events", 50, 0., 600.);

  //leptonic
  
  TH1F *h_pt_Z_G = new TH1F("h_pt_Z_G", " ; p_{T} (2l) [GeV] ; Events", 50., 0., 600.);
  
  //create a histogram for the absolute delta Phi phi.Had-phi.Lep

  TH1F *h_dPhi_ZH_G   = new TH1F("h_dPhi_ZH_G", " ; |#Delta#phi|(H,Z) ; Events", 25, 0., TMath::Pi());
  TH1F *h_phi_H_G = new TH1F("h_phi_H_G", " ; phi had ; Events", 25, -TMath::Pi(), TMath::Pi());
  TH1F *h_phi_Z_G = new TH1F("h_phi_Z_G", " ; phi lep ; Events", 25, -TMath::Pi(), TMath::Pi());
  ...
  TH1F *h_m_H_G = new TH1F("h_m_H_G"," ; m_{bbb(b)} [GeV] ; Events", 40, 0., 800.);
  TH1F *h_m_Z_G = new TH1F("h_m_Z_G"," ; m(2l) [GeV] ; Events", 50, 0., 300.);

  //create pT histograms for each b quark after sorting
  
  TH1F *h_pt_1_truth   = new TH1F("h_pt_1_truth"  , " ; p_{T} of the leading b quark (truth) ; Events"   , 50, 0., 500.); 
  TH1F *h_pt_2_truth   = new TH1F("h_pt_2_truth"  , " ; b_{2} p_{T}/truth ; Events"   , 50, 0., 500.);
  TH1F *h_pt_3_truth   = new TH1F("h_pt_3_truth"  , " ; b_{3} p_{T}/truth ; Events"   , 50, 0., 500.); 
  TH1F *h_pt_4_truth   = new TH1F("h_pt_4_truth"  , " ; b_{4} p_{T}/truth ; Events"   , 50, 0., 500.);

  TH1F *h_pt_1_global   = new TH1F("h_pt_1_global"  , " ; (q/g)_{1} p_{T} [GeV] ; Events"   , 50, 0., 500.); 
  TH1F *h_pt_2_global   = new TH1F("h_pt_2_global"  , " ; (q/g)_{2} p_{T} [GeV] ; Events"   , 50, 0., 500.);
  TH1F *h_pt_3_global   = new TH1F("h_pt_3_global"  , " ; (q/g)_{3} p_{T} [GeV] ; Events"   , 50, 0., 500.); 
  TH1F *h_pt_4_global   = new TH1F("h_pt_4_global"  , " ; (q/g)_{4} p_{T} [GeV] ; Events"   , 50, 0., 500.);


  //create pT  histograms for leading lepton and sub-leading lepton

  TH1F *h_pt_leadL    = new TH1F("h_pt_leadL",    " ; l_{1} p_{T} [GeV]  ; Events", 50, 0., 300.);
  TH1F *h_pt_subleadL = new TH1F("h_pt_subleadL", " ; l_{2} p_{T} [GeV]  ; Events", 50, 0., 300.);
  TH1F *h_dR_ll_G = new TH1F("h_dR_ll_G", " ; #DeltaR(ll) ; Events", 50, 0., 7.);
			       

  //create histograms for low dR analysis
 
  TH2F *h_pt2b_m2b_mindR_vector = new TH2F("h_pt2b_m2b_mindR_vector"," ; m(A_{1}) [GeV] ; p_{T}(A_{1}) [GeV]",30, 0., 200., 50, 0., 600.);
  TH2F *h_pt2b_m2b_other_vector  = new TH2F("h_pt2b_m2b_other_vector", " ; m(A_{2}) [GeV]; p_{T}(A_{2}) [GeV]",30, 0., 200., 50, 0., 600.);
  
  TH2F *h_m1_m2          = new TH2F("h_m1_m2",     " ; m(A_{1}); m(A_{2})", 30, 0., 200., 30, 0., 200.);
  TH1F *h_m2b_mindR      = new TH1F("h_m2b_mindR", " ; m(A_{1}) [GeV]; Events", 30, 0., 200.);
  TH1F *h_m2b_other      = new TH1F("h_m2b_other", " ; m(A_{2}) [GeV] ; Events", 30, 0., 200.);
				    
  TH2F *h_pT1_pT2_vector = new TH2F("h_pT1_pT2_vector", " ; p_{T}(A_{1});  p_{T}(A_{2})", 50, 0., 600., 50, 0., 600.);
  TH2F *h_dRmin_dRother   = new TH2F("h_dRmin_dRother", " ; #DeltaR_{min}; #DeltaR_{other}", 50, 0., 7., 50, 0., 7.);

  TH1F *h_dR_min_G = new TH1F("h_dR_min_G" , " ; #DeltaR_{min}  ; Events", 50, 0., 7.);
  TH1F *h_dR_other_G = new TH1F("h_dR_other_G", " ; #DeltaR_{other} ; Events", 50, 0., 7.);

  TH1F *h_pT_min_vector  = new TH1F("h_pT_min_vector"  ," ; p_{T}(A_{1}) [GeV]; Events", 50, 0., 600.);
  TH1F *h_pT_other_vector= new TH1F("h_pT_other_vector"," ; p_{T}(A_{2}) [GeV]; Events", 50, 0., 600.);

  //b quarks multiplicty
  TH1F *h_nb = new TH1F("h_nb", " ; number of quarks/gluons ; Events", 10, 0., 12.);

  //new mass variables 
  TH1F *h_dM_A1_A2_gen_level = new TH1F("h_dM_A1_A2_gen_level", " ; m(A_{1}) - m(A_{2}) ; Events", 50, -400., 200.);
  ...
  TH1F *h_eta_H = new TH1F("h_eta_H",  " ; #eta (4b) ; Events"  , 50, -5., 5.);
  ...
  TH1F *h_eta_Z = new TH1F("h_eta_Z" , " ; #eta (2l); Events"  , 50, -5., 5.);
  ...
  TH1F *h_pt_jet1  = new TH1F("h_pt_jet1",  " ;  b_{1}, p_{T} [GeV] ; Events", 50, 0., 500.);
  TH1F *h_eta_jet1 = new TH1F("h_eta_jet1", " ; b_{1}, #eta; Events", 50, -5., 5.);
  TH1F *h_phi_jet1 = new TH1F("h_phi_jet1", " ; b_{1}, #phi; Events", 25,-TMath::Pi(),TMath::Pi());
  TH1F *h_m_jet1   = new TH1F("h_m_jet1",   " ; b_{1}, mass; Events", 25, 0., 20.);
  
  TH1F *h_pt_jet2  = new TH1F("h_pt_jet2",  " ; b_{2}, p_{T} [GeV]; Events", 50, 0., 500.);
  TH1F *h_eta_jet2 = new TH1F("h_eta_jet2", " ; b_{2}, #eta; Events", 50, -5., 5.);
  TH1F *h_phi_jet2 = new TH1F("h_phi_jet2", " ; b_{2}, #phi; Events", 25,-TMath::Pi(),TMath::Pi());
  TH1F *h_m_jet2   = new TH1F("h_m_jet2",   " ; b_{2}, mass; Events", 25, 0., 20.);
  
  TH1F *h_pt_jet3  = new TH1F("h_pt_jet3",  " ; b_{3}, p_{T} [GeV] ; Events", 50, 0., 500.);
  TH1F *h_eta_jet3 = new TH1F("h_eta_jet3", " ; b_{3}, #eta; Events", 50, -5., 5.);
  TH1F *h_phi_jet3 = new TH1F("h_phi_jet3", " ; b_{3}, #phi; Events", 25,-TMath::Pi(),TMath::Pi());
  TH1F *h_m_jet3   = new TH1F("h_m_jet3",   " ; b_{3}, mass; Events", 25, 0., 20.);

  TH1F *h_pt_jet4  = new TH1F("h_pt_jet4",  " ; b_{4}, p_{T} [GeV] ; Events", 50, 0., 500.);
  TH1F *h_eta_jet4 = new TH1F("h_eta_jet4", " ; b_{4}, #eta; Events", 50, -5., 5.);
  TH1F *h_phi_jet4 = new TH1F("h_phi_jet4", " ; b_{4}, #phi; Events", 25,-TMath::Pi(),TMath::Pi());
  TH1F *h_m_jet4   = new TH1F("h_m_jet4",   " ; b_{4}, mass; Events", 25, 0., 20.);

  TH1F *h_pt_b1 = new TH1F("h_pt_b1", " ;  b_{1}, p_{T} [GeV] ; Events", 50, 0., 500.);
  ...
  TH1F *h_dR_min = new TH1F("h_dR_min", " ; #DeltaR_{min} ; Events", 50, 0., 7.);
  TH1F *h_dR_other = new TH1F("h_dR_other", " ; #DeltaR_{other} ; Events", 50, 0., 7.);
  ...
  TH1F *h_deltaR_correct_pair = new TH1F("h_deltaR_correct_pair", " ; #DeltaR ; Events", 50, 0., 7.);

  TH2F *h_ptjet_pt2b_bb1 = new TH2F("h_ptjet_pt2b_bb1", " ; p_{T} jet [GeV] ; p_{T} (2b), truth [GeV]", 50, 0., 250., 50., 0., 250.);
  TH2F *h_ptjet_pt2b_bb2 = new TH2F("h_ptjet_pt2b_bb2", " ; p_{T} jet [GeV] ; p_{T} (2b), truth [GeV]", 50, 0., 250., 50., 0., 250.);
  ...
  Long64_t nbytes = 0, nb = 0;
   for (Long64_t jentry=0; jentry<nentries;jentry++) {
	...
	float dPhi_ZH_G = fabs(phi_H_G - phi_Z_G);
	...
	if(signal){
	  ...
	  h_m2b_truth->Fill(m_2b_A1, weight); h_m2b_truth_other->Fill(m_2b_A2, weight);
    ...
    //minimum deltaR analysis, pT(2b)-m(2b) plane

    float dR_min_temp = 999;
    TLorentzVector jet1_min, jet2_min;

    for(std::vector<TLorentzVector>::size_type i=0; i < vec_jet.size(); i++){
     
      TLorentzVector jet1 = vec_jet[i];
      
      for(std::vector<TLorentzVector>::size_type j = i + 1; j < vec_jet.size(); j++){
	TLorentzVector jet2 = vec_jet[j];

	float deta_jet = fabs(jet1.Eta() - jet2.Eta());
	float dphi_jet = fabs(jet1.Phi() - jet2.Phi());
	float dR_jet   = sqrt(deta_jet*deta_jet + dphi_jet*dphi_jet);

	if (dR_jet < dR_min_temp){
	  dR_min_temp = dR_jet;
	  jet1_min = jet1;
	  jet2_min = jet2;
	}
